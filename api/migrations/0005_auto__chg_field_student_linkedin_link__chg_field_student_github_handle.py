...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.linkedin_link'
        db.alter_column(u'api_student', 'linkedin_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Student.github_handle'
        db.alter_column(u'api_student', 'github_handle', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Student.linkedin_link'
        db.alter_column(u'api_student', 'linkedin_link', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))

        # Changing field 'Student.github_handle'
        db.alter_column(u'api_student', 'github_handle', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))
